...
def upload_file_generic():
    ...
    try:
        ...
        return success_response(data={"file_url": file_url}, message="File uploaded successfully", status_code=201)
...
def upload_signature_generic():
    ...
    try:
        ...
        return success_response(data={"signature_url": file_url}, message="Signature uploaded successfully", status_code=201)
    except Exception as e:
