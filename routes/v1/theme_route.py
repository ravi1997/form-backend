...
from utils.response_helper import BaseSerializer, error_response, success_response
...
def list_themes():
    ...
    try:
        ...
        error_logger.error(f"Failed to list themes: {exc}", exc_info=True)
        return error_response(message="Failed to list themes", status_code=500)
