...
def register_blueprints(app):
    ...
    app.register_blueprint(form_bp, url_prefix="/api/v1/forms")
    app.register_blueprint(translation_bp, url_prefix="/api/v1/forms/translations")
    app.register_blueprint(library_bp, url_prefix="/api/v1/custom-fields")
    app.register_blueprint(
        library_bp, url_prefix="/api/v1/templates", name="form_templates"
    )
    app.register_blueprint(permissions_bp, url_prefix="/api/v1/forms")
    app.register_blueprint(view_bp, url_prefix="/api/v1/view")
    ...
    app.register_blueprint(dashboard_settings_bp, url_prefix="/api/v1/dashboard-settings")
    ...
    app.register_blueprint(advanced_responses_bp, url_prefix="/api/v1/forms")
    
    # User & System Management
    app.register_blueprint(user_bp, url_prefix="/api/v1/users")
    app.register_blueprint(
        system_settings_bp, url_prefix="/api/v1/admin/system-settings"
    )
    app.register_blueprint(env_config_bp, url_prefix="/api/v1/admin/env-config")
    app.register_blueprint(system_bp, url_prefix="/api/v1/system")
    
    app.logger.info("All blueprints registered successfully with normalized /api/v1/ prefix.")
